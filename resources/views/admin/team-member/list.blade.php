			...
			<div class="portlet box blue-hoki">
				...
				<div class="portlet-body">
                    ...
                    <div class="table-toolbar">
                        ...
                        <div class="btn-group">
                            <a href="{{ route('admin.team-member.create') }}" class="btn green">
                                Agregar registro
                    ...
                    {!! Form::model(Request::all(), ['route' => 'admin.team-member.index', 'method' => 'GET']) !!}
                        ...
                        <table class="table table-striped table-bordered" id="table2">
                            ...
                            <tbody>
                                <tr>
                                    <td class="col-md-6">
                                        {!! Form::text('nombre', null, ['class' => 'form-control input-sm', 'placeholder' => 'Registro']) !!}
                                    </td>
                                    <td class="col-md-2">
                                    ...
                                    <td class="text-center col-md-2">
                                        ...
                                        <a href="{!! route('admin.team-member.index') !!}" class="btn btn-danger">
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a href="{{ route('admin.team-member.edit', $item->id) }}">Editar</a></li>
...
{!! Form::open(['route' => ['admin.team-member.destroy', ':REGISTER'], 'method' => 'DELETE', 'id' => 'FormDeleteRow']) !!}
{!! Form::close() !!}
