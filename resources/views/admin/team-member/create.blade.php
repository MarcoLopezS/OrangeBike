    ...
    <div class="col-lg-12">
        ...
        <div class="portlet box blue-hoki">
            ...
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-globe"></i>Integrante - Nuevo
                </div>
            </div>

            <div class="portlet-body form">
                {!! Form::open(['route' => 'admin.team-member.store', 'method' => 'POST', 'class' => 'form-horizontal form-bordered', 'files' => 'true']) !!}
                    ...
                    <div class="form-group">
                        <div class="col-md-12 text-right">
                            ...
                            <a href="{{ route('admin.team-member.index') }}" class="btn btn-responsive btn-default btn-md">Cancelar</a>
                        </div>
                    </div>
