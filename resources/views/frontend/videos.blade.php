...
<div id="galeria-fotos" class="container">
	...
	<section class="col-lg-8">
		...
		<h3 class="titulo-multimedia">Últimos Videos</h3>
		...
		<div class="row">
			...
			<article class="blog-nota-item destacada col-lg-12">
				<a href="/blog-nota">
					...
					<div class="imagen">
						<iframe width="100%" height="400" src="https://www.youtube.com/embed/eaeGADdwn0g" frameborder="0" allowfullscreen></iframe>
					</div>
		...
		<h3 class="titulo-multimedia">Más Videos</h3>
